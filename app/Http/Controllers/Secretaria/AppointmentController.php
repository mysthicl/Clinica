...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('secretaria.appointments.index')
    ...
    public function edit(Appointment $appointment)
    {
        ...
        if ($appointment->status !== 'Agendada') {
            return back()->with('error', 'Solo se pueden editar citas con estado Agendada.');
        }
    ...
    {
        if ($appointment->status !== 'Agendada') {
            return back()->with('error', 'Solo se pueden cancelar citas con estado Agendada.');
        }
